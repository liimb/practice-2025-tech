...
public class DefiniteIntegralTests
{
    ...
    public void DefiniteIntegralTest_FuncSinCosCorrectCalculation()
    {
        ...
        [Fact]
    public void DefiniteIntegralTest_FuncSinWithoutThreadsCorrectCalculation()
    {
        Assert.Equal(0.2566, DefiniteIntegral.Solve(-1, 5, _sin, 1e-5), 1e-4);
    }
    
    [Fact]
    public void DefiniteIntegralTest_FuncLinearWithoutThreadsCorrectCalculation()
    {
        Assert.Equal(12.5, DefiniteIntegral.Solve(0, 5, _x, 1e-6), 1e-5);
    }
    
    [Fact]
    public void DefiniteIntegralTest_FuncSinCosWithoutThreadsCorrectCalculation()
    {
        Assert.Equal(0.268, DefiniteIntegral.Solve(10, 20, _sinCos, 1e-1), 1e-2);
    }
}
